...
const BookProduct = ({ visible, handleOk, handleCancel }) => {
    return (
        <Modal
            visible={visible}
        ...
        >
            <Space direction="vertical">
                <Select defaultValue="Air Compressor 12 GAS" onChange={handleChange}
                    style={{ width: 280 }}>
                    <Option value="Air Compressor 12 GAS">Air Compressor 12 GAS</Option>
                    <Option value="Air Compressor 5 Electric">Air Compressor 5 Electric</Option>
